...
# this will be eval'd in the functions below because arrays can't be exported
export AUX_PLATFORMS='declare -A aux_platforms=( [uno]="microduino:avr:16MHzatmega328" [16MHzatmega644]="microduino:avr:16MHzatmega644" [16MHzatmega1284]="microduino:avr:16MHzatmega1284" [usb32u416m]="microduino:avr:usb32u416m" )'
