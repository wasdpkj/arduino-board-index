...
DEPENDENCY_OUTPUT=$(arduino --pref "boardsmanager.additional.urls=https://github.com/wasdpkj/arduino-board-index/raw/gh-pages/package_adafruit_index.json,https://github.com/wasdpkj/arduino-board-index/raw/gh-pages/package_microduino_index.json" --save-prefs 2>&1)
