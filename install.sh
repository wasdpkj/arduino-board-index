...
DEPENDENCY_OUTPUT=$(arduino --pref "boardsmanager.additional.urls=https://github.com/wasdpkj/arduino-board-index/raw/gh-pages/for_travis/package_adafruit_index.json" --save-prefs 2>&1)
